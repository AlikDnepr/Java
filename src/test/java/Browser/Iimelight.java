...
public class Iimelight {
    ...
    /**
     * Performs login on the application and navigates to the Administration page.
    ...
    /**
     * Interacts with checkboxes on the Administration page, including highlighting and clicking them.
     * @param driver The WebDriver instance for browser automation.
     * @param js The JavascriptExecutor object for executing JavaScript code.
     * @throws InterruptedException Handles thread sleep interruptions.
     **/
